...
@Desc    :   otc 8, 2024, copy from datagen2.py commit id 9193865
'''
...
if __name__ == "__main__":
    ...
    for topic in topics:
        data_folder = f"data/processed/News1k2024-300/{topic}/200"
        exp_folder = f"data/experiments/llmq-{llm_q}/llmr-{llm_r}/docp-{doc_prompt}/200/{topic}"
